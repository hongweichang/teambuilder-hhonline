...
namespace HHOnline.QueryBuilder
{
    ...
    public class WhereStatement : List<List<WhereClause>>
    {
        ...
        /// <param name="operator">操作运算符</param>
        ...
        /// 确定子句Level存在
        /// </summary>
        /// <param name="level">子句Level</param>
            ...
            if (value != null && value != System.DBNull.Value)
            {
                switch (comparisonOperator)
                {
                    ...
                    case Comparison.NotIn:
                        Output = fieldName + " Not IN (" + FormatSQLValue(value) + ")"; break;
                }
            }
