    ...
    public class SqlShopDataProvider : ShopDataProvider
    {
        ...
        public override ProductPrice CreateUpdatePrice(ProductPrice price, DataProviderAction action, out DataActionStatus status)
        {
            ...
            ELParameter[] elParameters = new ELParameter[]{
                ...
                new ELParameter("@PriceGradeA",DbType.Decimal,DataHelper.IntOrNull(price.PriceGradeA)),
                new ELParameter("@PriceGradeB",DbType.Decimal,DataHelper.IntOrNull(price.PriceGradeB)),
                new ELParameter("@PriceGradeC",DbType.Decimal,DataHelper.IntOrNull(price.PriceGradeC)),
                new ELParameter("@PriceGradeD",DbType.Decimal,DataHelper.IntOrNull(price.PriceGradeD)),
                new ELParameter("@PriceGradeE",DbType.Decimal,DataHelper.IntOrNull(price.PriceGradeE)),
