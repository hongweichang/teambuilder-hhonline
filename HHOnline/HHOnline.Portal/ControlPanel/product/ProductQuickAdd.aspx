<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/Masters/ControlPanelMaster.master" AutoEventWireup="true" CodeFile="ProductQuickAdd.aspx.cs" Inherits="ControlPanel_product_ProductQuickAdd" %>
...
<table class="postform" cellpadding="10" cellspacing="10">
    <tr>
        <th style="width:15%" id="hfCatListHolder">
            产品分类信息
        ...
        <td style="width:85%">
            ...
            <a href="javascript:{}" title="设置" onclick="selectCategories()" class="setting">[设置]</a>
        </td>
    </tr>
    <tr>
        <th>产品名称</th>
        <td>
            ...
            <asp:RequiredFieldValidator ID="rfv1" ControlToValidate="txtProductName" runat="server" ErrorMessage="必须填写！"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <th>产品品牌</th>
        <td>
            <asp:DropDownList Width="300px" ID="ddlBrands" runat="server"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <th id="hfIndListHolder">产品行业
            <asp:HiddenField ID="hfIndustries" runat="server" />
            <asp:HiddenField ID="hfIndHTML" runat="server" />
        </th>
        <td>
            <span id="spanIndustries" ></span>
            <a href="javascript:{}" title="设置" onclick="selectIndustries()" class="setting">[设置]</a>
        </td>
    </tr>
    <tr>
        <th>产品关键字</th>
        <td>
            ...
            <asp:RequiredFieldValidator ID="rfv2" ControlToValidate="txtKeywords" runat="server" ErrorMessage="必须填写！"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <th>产品摘要/简介</th>
        <td>
            ...
            <asp:RequiredFieldValidator ID="rfv3" ControlToValidate="txtAbstract" runat="server" ErrorMessage="必须填写！"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <th>详细介绍</th>
    ...
    <tr>
        <th>产品图片</th>
        <td>
            <div id="productImages" style="width:606px;"></div>
    ...
    <tr>
        <th>产品栏目(30天有效期)</th>
        <td>
            <hc:FocusTypeList ID="ddlFocusType" runat="server" RepeatDirection="Horizontal" SelectedValue="None" CssClass="focusType">
            </hc:FocusTypeList>
        </td>
    </tr>
    ...
    <tr>
        <th>终端正常价<sup>1级</sup></th>
        <td> 
            <asp:TextBox ID="txtPrice1" runat="server" Width="200px" ></asp:TextBox>
            <asp:RegularExpressionValidator ID="rev2" runat="server" ControlToValidate="txtPrice1"
             ValidationExpression="^(-)?(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$" ErrorMessage="必须是数字(可精确到小数点后2位)！"></asp:RegularExpressionValidator>
        </td>
    </tr>
    <tr>
        <th>终端最低价<sup>2级</sup></th>
        <td>
    ...
    <tr>
        <th>促销价(仅促销有效)</th>
        <td>
            <asp:TextBox ID="txtPromotionPrice" runat="server" Width="200px" ></asp:TextBox>
    ...
    <asp:Panel ID="pnlNavigation" runat="server" Visible="false">
        <tr>
            <th>栏目设置</th>
            <td class="cat_navC"><asp:LinkButton ID="lnkSetFocus" runat="server" Text="跳转到栏目设置页"></asp:LinkButton></td>
        </tr>
        <tr>
            <th>价格设置</th>
            <td class="cat_navC"><asp:LinkButton ID="lnkSetPrice" runat="server" Text="跳转到价格设置页"></asp:LinkButton></td>
        </tr>
    </asp:Panel>
    ...
    <tr>
        <th>是否上架</th>
        <td>
        <hc:YesNoRadioButtonList ID="rdPublish" runat="server"></hc:YesNoRadioButtonList>
        </td>
    </tr>
    <tr>
        <th>&nbsp;</th>
