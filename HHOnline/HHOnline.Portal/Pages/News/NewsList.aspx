...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderContent" runat="Server">
    <div id="main">
        ...
        <a class="rss_link" href="javascript:void(0)" title="订阅Rss">&nbsp;</a> <a href="<% Response.Write("news-newslist&v=1&cate=" + Request.QueryString["cate"] + "&p=" + Request.QueryString["p"]); %>"
            title="查看方式 - 列表" class="news_list">&nbsp;</a> <a href="<%Response.Write("news-newslist&v=0&cate=" + Request.QueryString["cate"] + "&p=" + Request.QueryString["p"]);%>"
