<%@ Page Language="C#" MasterPageFile="~/Masters/AdminMasterPage.master" AutoEventWireup="true"
    CodeFile="ProductAdd.aspx.cs" Inherits="Pages_Profiles_ProductAdd" Title="新增产品" %>

<%@ Register Src="../../ControlPanel/product/ProductPropertyAdd.ascx" TagName="ProductPropertyAdd"
    TagPrefix="ucProperty" %>
