<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/DetailMasterPage.master" AutoEventWireup="true" CodeFile="CompanyUserDetails.aspx.cs" Inherits="Pages_Profiles_CompanyUserDetails" %>
    ...
    <ItemTemplate>
         <table cellpadding="0" cellspacing="0"  class="detail">
                <tr>
                 ...
                 <tr>
                    <th>职务</th>
                    <td colspan="3"><%# ParseString(Eval("Title").ToString())%></td>
                </tr>
                 <tr>
                    <th>备注</th>
