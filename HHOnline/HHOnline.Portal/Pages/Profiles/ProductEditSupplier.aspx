...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
    <table class="postform" cellspacing="10" cellpadding="10">
        ...
        <tr>
            ...
            <td>
                <hc:DateSpan ID="txtDeliverySpan" runat="server" />
            </td>
        </tr>
        <tr>
            <th style="width: 180px;">
            ...
            <td>
                <hc:DateSpan ID="txtWarrantySpan" runat="server" />
            </td>
        </tr>
        <tr>
            <th style="width: 180px;">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="btnPostBack" runat="server" Text="返 回" CausesValidation="false" Visible="false" />
            </td>
        </tr>
    </table>
    <div id="regionViewer">
