...
namespace HHOnline.Shops.Providers
{
    ...
    public abstract class ShopDataProvider
    {
        ...
        public static ProductPrice PopulateProductPriceFromIDataReader(IDataReader dr)
        {
            ...
            productPrice.PricePromotion = DataRecordHelper.GetDecimal(dr, "PricePromotion");
            productPrice.PriceFloor = DataRecordHelper.GetDecimal(dr, "PriceFloor");
            productPrice.PricePurchase = DataRecordHelper.GetDecimal(dr, "PricePurchase");
            productPrice.PriceGradeA = DataRecordHelper.GetDecimal(dr, "PriceGradeA");
            productPrice.PriceGradeB = DataRecordHelper.GetDecimal(dr, "PriceGradeB");
            productPrice.PriceGradeC = DataRecordHelper.GetDecimal(dr, "PriceGradeC");
            productPrice.PriceGradeD = DataRecordHelper.GetDecimal(dr, "PriceGradeD");
            productPrice.PriceGradeE = DataRecordHelper.GetDecimal(dr, "PriceGradeE");
